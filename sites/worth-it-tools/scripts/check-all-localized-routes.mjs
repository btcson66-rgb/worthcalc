...
const approvedStagedEditorialRoutes = new Set([
  ...
  'guides/air-fryer-cost-per-cooking-cycle-used',
  'guides/rice-cooker-cost-per-cooking-cycle-used',
  'guides/slow-cooker-cost-per-cooking-hour-used',
  ...
  'guides/printer-electricity-cost-per-print-job-used',
  'guides/scanner-electricity-cost-per-scanning-session-used',
  'guides/3d-printer-electricity-cost-per-print-used',
  'guides/gaming-console-electricity-cost-per-gaming-hour-used',
  'guides/soundbar-electricity-cost-per-watched-hour-used',
  'guides/desktop-speakers-electricity-cost-per-listening-hour-used',
  'guides/label-maker-electricity-cost-per-labeling-session-used',
  'guides/paper-shredder-electricity-cost-per-shredding-session-used',
  'guides/laminator-electricity-cost-per-laminating-batch-used',
  ...
  'guides/ceiling-fan-electricity-cost-per-cooling-hour-used',
  'guides/bathroom-ventilation-fan-electricity-cost-per-shower-used',
  'guides/water-cooler-electricity-cost-per-cooling-day-used',
  'guides/humidifier-electricity-cost-per-humidifying-hour-used',
  'guides/aquarium-air-pump-electricity-cost-per-filtration-day-used',
  'guides/electric-air-pump-electricity-cost-per-inflation-session-used',
  'guides/electric-toothbrush-electricity-cost-per-charging-day-used',
  'guides/electric-shaver-electricity-cost-per-grooming-session-used',
  'guides/sewing-machine-electricity-cost-per-sewing-hour-used',
  'guides/soldering-iron-electricity-cost-per-repair-hour-used',
  'guides/glue-gun-electricity-cost-per-crafting-hour-used',
  'guides/electric-hand-mixer-electricity-cost-per-mixing-session-used',
  'guides/aquarium-heater-electricity-cost-per-tank-day-used',
  'guides/terrarium-heat-lamp-electricity-cost-per-heating-hour-used',
  'guides/electric-insect-zapper-electricity-cost-per-overnight-used',
  'guides/outdoor-string-lights-electricity-cost-per-evening-used',
  'guides/garage-door-opener-electricity-cost-per-cycle-used',
  'guides/electric-fireplace-electricity-cost-per-heating-hour-used',
  'guides/portable-air-conditioner-electricity-cost-per-cooling-session-used',
  'guides/pool-pump-electricity-cost-per-filtration-cycle-used',
  'guides/dehumidifier-electricity-cost-per-laundry-drying-session-used',
  'guides/electric-wine-cooler-electricity-cost-per-storage-day-used',
  'guides/attic-fan-electricity-cost-per-ventilation-hour-used',
  'guides/solar-inverter-electricity-cost-per-monitoring-day-used',
