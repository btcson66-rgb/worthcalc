...
const slugs = [
  'true-cost-of-convenience-delivery',
  'true-cost-of-free-shipping-threshold',
  'true-cost-of-extended-warranty',
  'true-cost-of-buy-now-pay-later',
  'true-cost-of-rental-car',
  'true-cost-of-home-service-plan',
  'true-cost-of-upgrade-feature',
];
...
if (failures.length) {
  console.error('SEO program 013 check failed (' + failures.length + '):');
  failures.forEach((failure) => console.error('- ' + failure));
  process.exit(1);
}
console.log('SEO program 013 passed: ' + pages.length + ' localized true-cost guides have one H1, indexable canonical/robots, Article + BreadcrumbList schema, CFPB attribution, internal links, and sitemap entries.');
