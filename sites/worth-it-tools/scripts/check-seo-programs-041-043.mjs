...
const definitions = {
  '041': { slug: 'computer-electricity-cost-per-day-used', sources: ['energystar.gov', 'eia.gov'] },
  '042': { slug: 'monitor-electricity-cost-per-work-hour-used', sources: ['energystar.gov', 'eia.gov'] },
  '043': { slug: 'television-electricity-cost-per-watched-hour-used', sources: ['energystar.gov', 'eia.gov'] },
};
const definition = definitions[program];
if (!definition) throw new Error('Usage: node scripts/check-seo-programs-041-043.mjs 041|042|043');
