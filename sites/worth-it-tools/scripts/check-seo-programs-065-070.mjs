...
const topics = {
  '065': 'bread-maker-cost-per-loaf-used',
  '066': 'food-dehydrator-cost-per-drying-hour-used',
  '067': 'electric-yogurt-maker-cost-per-batch-used',
  '068': 'electric-egg-cooker-cost-per-cooking-cycle-used',
  '069': 'electric-lunch-box-cost-per-heating-cycle-used',
  '070': 'electric-can-opener-cost-per-use-used',
};
