...
const topics = {
  '071': 'countertop-ice-maker-cost-per-batch-used',
  '072': 'electric-citrus-juicer-cost-per-juice-session-used',
  '073': 'electric-meat-grinder-cost-per-grinding-session-used',
  '074': 'electric-pasta-maker-cost-per-batch-used',
  '075': 'electric-milk-frother-cost-per-frothing-session-used',
  '076': 'electric-food-warmer-cost-per-heating-hour-used',
};
