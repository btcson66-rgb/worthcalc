...
const topics = {
  '077': 'printer-electricity-cost-per-print-job-used',
  '078': 'scanner-electricity-cost-per-scanning-session-used',
  '079': '3d-printer-electricity-cost-per-print-used',
  '080': 'gaming-console-electricity-cost-per-gaming-hour-used',
  '081': 'soundbar-electricity-cost-per-watched-hour-used',
  '082': 'desktop-speakers-electricity-cost-per-listening-hour-used',
};
