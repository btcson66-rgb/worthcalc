...
const topics = {
  '083': 'label-maker-electricity-cost-per-labeling-session-used',
  '084': 'paper-shredder-electricity-cost-per-shredding-session-used',
  '085': 'laminator-electricity-cost-per-laminating-batch-used',
  '086': '3d-scanner-electricity-cost-per-scanning-session-used',
  '087': 'electric-standing-desk-electricity-cost-per-adjusted-day-used',
  '088': 'smart-speaker-electricity-cost-per-listening-hour-used',
};
