...
description: "Calculate how negative equity changes a new auto loan. Compare payoff, trade-in value, amount financed, interest, and the risk of being underwater again."
...
- cash you bring to the transaction;
- a lower net purchase price;
- or money added to the new loan.
...
- dealer trade-in value: $18,000
- negative equity: $4,000
- new vehicle financing need before old debt: $28,000
- proposed term: 72 months
- example APR: 6%
...
- 12 months of current loan payments;
- expected necessary maintenance that you can reasonably document;
- the payoff after 12 months;
- a conservative range of vehicle value after 12 months.
...
- total interest;
- payoff after 24 months;
- payoff after 36 months;
- household cash remaining after each payment.
...
- Can necessary expenses still be paid without revolving credit?
- Does the new payment consume the emergency-fund contribution?
- Would an early sale become more likely?
- If you had to sell in month 24, would another negative-equity gap appear?
...
- new vehicle price;
- taxes and mandatory transaction costs;
- add-ons;
- trade-in value.
...
- the shortfall is small relative to available cash;
- the borrower plans to keep the replacement vehicle for a long time;
- the new term is shorter rather than longer;
- the current vehicle has a major documented repair problem;
- the household's emergency cash is already thin;
- the borrower expects another vehicle change within two or three years.
...
| Situation | What to test first |
|---|---|
| Small shortfall and strong cash reserve | Cash payoff versus rollover |
| Large shortfall, current car still usable | Waiting and principal reduction |
| Current car has major reliability problems | Add documented repair/downtime cost |
| Post-purchase cash would be very low | Liquidity stress test |
| Likely trade again in 2–3 years | Month-24 and month-36 payoff |
| Dealer focuses only on payment | Reconstruct all three transaction layers |
