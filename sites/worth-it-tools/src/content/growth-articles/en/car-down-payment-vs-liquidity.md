...
description: "Compare a larger car down payment with keeping more cash. Model the monthly payment, interest, post-purchase runway, and early-sale loan balance."
...
- financing interest and loan fees,
- down payment,
- insurance,
- fuel or charging,
- maintenance,
...
- out-the-door price: $32,000
- APR assumption for illustration: 6%
- term: 60 months
- no trade-in
...
- Estimated payment: about **$557/month**
- Estimated total interest: about **$4,607**

### Option B: 20% down

- Down payment: $6,400
- Amount financed: $25,600
- Estimated payment: about **$495/month**
- Estimated total interest: about **$4,095**
...
| Month | Loan balance | Conservative resale assumption | Equity / shortfall |
|---|---:|---:|---:|
| 12 |  |  |  |
| 24 |  |  |  |
| 36 |  |  |  |
...
- “I have $10,000 for a down payment,” and
- “I also have $10,000 of emergency savings,”
...
- use a moderate down payment,
- preserve the extra $3,200 in liquid cash,
- if the reserve remains above your target after six months, make a principal-only payment if your contract allows it.
...
|---|---|
| Large existing cash reserve | Lower principal and interest |
| Thin emergency savings | Post-purchase liquidity |
| Unstable income | Cash runway |
| Likely to sell early | Early loan balance |
| High-rate debt elsewhere | Whole balance sheet, not car loan alone |
...
- [ ] Out-the-door price used
- [ ] Trade-in loan payoff deducted
- [ ] Same term compared where possible
- [ ] Actual APR used
- [ ] Post-purchase cash calculated
- [ ] Insurance and ownership costs included
- [ ] Early-sale balance checked
- [ ] Income-drop scenario tested
- [ ] Emergency savings not double-counted
