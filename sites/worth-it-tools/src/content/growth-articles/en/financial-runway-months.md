...
description: "Calculate financial runway from accessible cash, stress spending, and conservative income. Use monthly cash-flow scenarios to find the real low-cash point."
...
1. Increase accessible cash
2. Reduce rigid spending
3. Preserve reliable income
...
1. **Operating cash** for the next 30–60 days of known bills.
2. **Shock buffer** for payment delays and small disruptions.
3. **Emergency reserve** for a larger loss of income or major unexpected expense.
