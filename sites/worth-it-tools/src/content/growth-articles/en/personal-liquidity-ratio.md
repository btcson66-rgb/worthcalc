...
description: "Calculate how many months liquid assets can cover essential spending, then stress-test cash after major purchases, higher expenses, and income shocks."
...
1. **Cash-tier liquidity**
2. **Expanded liquidity**, including assets you could reasonably use but that carry price or access risk
...
CFPB — assess spending using actual bills and irregular expenses:
