...
一般 job offer comparator 會把 signing bonus 加在第一年總薪酬，卻很少處理 clawback。WorthCalc 009 的差異化關鍵詞就是 clawback-adjusted break-even。要建立持有期曲線：第 6、12、18、24、36 月若離職，各自可保留多少簽約獎金、累積底薪是多少。一次性 bonus 還不能拿來永久支撐固定支出，因為第二年不一定再有。
...
這頁只處理「簽約獎金 vs 高底薪」這個窄搜尋任務。它不應取代泛用預算、通勤、訂閱、會員或薪資文章，也不應再建立一個名稱不同、公式相同的通用 calculator。Codex 上架時應把它放進相鄰主題 cluster，從既有頁導入，而不是製造孤島頁。
