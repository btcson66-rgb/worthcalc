...
export const raiseInflationGuides: Partial<Record<Locale, DecisionGuideContent>> = {
  ...
  fr: {
    id: 'raise-inflation', labels: labels.fr,
    directAnswer: 'Une hausse de salaire améliore le pouvoir d’achat moyen seulement si (1 + hausse) ÷ (1 + inflation) − 1 est positif. Avec 36 000 € brut par an et +2%, le nouveau salaire atteint 36 720 €. En prenant comme scénario l’IPC France de juin 2026, +1,8% sur un an publié par l’Insee, la hausse réelle est 1,02÷1,018−1 = +0,20% et le salaire vaut 36 070,73 € aux prix antérieurs.',
    inputs: ['Ancien salaire brut annuel, mensuel ou horaire dans une unité constante', 'Taux de hausse nominale du salaire de base', 'Variation de l’IPC officiel sur les mêmes dates de début et de fin', 'Comparaison en glissement annuel, moyenne annuelle ou entre deux indices', 'Évolution du temps de travail, des primes et avantages', 'Impact sur le net après cotisations, prélèvement et mutuelle', 'Écart entre vos dépenses personnelles et le panier moyen de l’IPC'],
    formula: 'Nouveau salaire nominal = ancien salaire × (1 + hausse%). Variation réelle exacte = [(1 + hausse%) ÷ (1 + inflation%) − 1] × 100. Nouveau salaire en euros de l’ancienne période = nouveau nominal ÷ (1 + inflation%).',
    workedExample: '36 000 €×1,02 = 36 720 €. Avec l’IPC de juin 2026 à +1,8% sur un an, variation réelle = (1,02÷1,018−1)×100 = +0,20%. Équivalent aux prix antérieurs = 36 720 €÷1,018 = 36 070,73 €. La hausse dépasse légèrement l’inflation moyenne du scénario.',
    sensitivity: [{ scenario: 'Hausse égale à l’IPC', input: '1,8% et 1,8%', result: '0,00% réel ; 36 000 € équivalents' }, { scenario: 'Hausse limitée à 1%', input: '2% devient 1%', result: '−0,79% réel ; 35 717,09 € équivalents' }, { scenario: 'Inflation à 3%', input: '1,8% devient 3%', result: '−0,97% réel ; 35 650,49 € équivalents' }, { scenario: 'Hausse à 3%', input: '2% devient 3%', result: '+1,18% réel ; 36 424,36 € équivalents' }],
    cta: { label: 'Comparer hausse et IPC sur la même période', href: '#raise-inflation-calculator' },
    limitations: ['Le +1,8% est un exemple daté de juin 2026 ; saisissez la valeur Insee qui correspond exactement à votre période.', 'Depuis 2026, l’IPC Insee est en base 2025 ; ne calculez pas une variation en soustrayant deux points d’indice de bases incompatibles.', 'L’Insee précise que l’IPC mesure des prix moyens et n’est pas un indice individuel du coût de la vie.', 'Le calcul sur brut ne remplace pas une comparaison du net, du temps de travail, des primes et avantages.'],
    sources: [{ label: 'Insee — définition de l’IPC, mesure de l’inflation et distinction avec le coût de la vie', href: 'https://www.insee.fr/fr/metadonnees/definition/c1557' }, { label: 'Insee — IPC juin 2026, +1,8% sur un an, publié le 10-07-2026', href: 'https://www.insee.fr/fr/statistiques/9021808' }], lastVerified: '2026-07-19',
  },
  de: {
    id: 'raise-inflation', labels: labels.de,
    directAnswer: 'Eine Gehaltserhöhung steigert die durchschnittliche Kaufkraft nur, wenn (1 + Erhöhung) ÷ (1 + Inflationsrate) − 1 positiv ist. Bei 48.000 € brutto und 2% Erhöhung steigt das Nominalgehalt auf 48.960 €. Mit der vorläufigen Destatis-Inflationsrate für Juni 2026 von 2,3% ergibt sich 1,02÷1,023−1 = −0,29%; in Preisen des Vorjahres sind das 47.859,24 €.',
    inputs: ['Altes Bruttogehalt pro Jahr, Monat oder Stunde in gleicher Einheit', 'Nominale dauerhafte Erhöhung des Grundgehalts', 'Amtliche VPI-Veränderung mit identischem Anfangs- und Endzeitpunkt', 'Kennzeichnung als Vorjahresmonat, Jahresdurchschnitt oder Indexvergleich', 'Änderungen bei Arbeitszeit, Bonus und Sachleistungen', 'Nettoeffekt nach Steuern, Sozialbeiträgen und Abzügen', 'Abweichung der eigenen Miete, Mobilität und Ernährung vom durchschnittlichen Warenkorb'],
    formula: 'Neues Nominalgehalt = altes Gehalt × (1 + Erhöhung%). Exakte reale Veränderung = [(1 + Erhöhung%) ÷ (1 + Inflation%) − 1] × 100. Neues Gehalt in Preisen der alten Periode = neues Nominalgehalt ÷ (1 + Inflation%).',
    workedExample: '48.000 €×1,02 = 48.960 €. Bei der vorläufigen Juni-2026-Inflationsrate von 2,3% gilt: (1,02÷1,023−1)×100 = −0,29%. Kaufkraftäquivalent = 48.960 €÷1,023 = 47.859,24 €. Zwei Prozent nominal gleichen den durchschnittlichen Preisanstieg hier nicht aus.',
    sensitivity: [{ scenario: 'Erhöhung entspricht Inflation', input: '2,3% und 2,3%', result: '0,00% real; 48.000 € äquivalent' }, { scenario: 'Erhöhung 3%', input: '2% wird 3%', result: '+0,68% real; 48.328,45 € äquivalent' }, { scenario: 'Inflation 1,5%', input: '2,3% wird 1,5%', result: '+0,49% real; 48.236,45 € äquivalent' }, { scenario: 'Erhöhung 1,5%', input: '2% wird 1,5%', result: '−0,78% real; 47.624,63 € äquivalent' }],
    cta: { label: 'Gehaltserhöhung mit passendem VPI vergleichen', href: '#raise-inflation-calculator' },
    limitations: ['2,3% ist ein vorläufiges, datiertes Juni-2026-Beispiel; für die Entscheidung den amtlichen Wert des eigenen Zeitraums einsetzen.', 'Destatis bezeichnet die Veränderung zum Vorjahresmonat oder Vorjahr als Inflationsrate; Monatsrate und Jahresrate nicht vermischen.', 'Der VPI bildet einen durchschnittlich gewichteten Warenkorb ab, nicht die persönliche Teuerung.', 'Bruttovergleich enthält Steuern, Beiträge, Stunden, Boni und Zusatzleistungen nicht automatisch.'],
    sources: [{ label: 'Destatis — Verbraucherpreisindex, Warenkorb und Inflationsrate', href: 'https://www.destatis.de/DE/Themen/Wirtschaft/Preise/Verbraucherpreisindex/_inhalt.html' }, { label: 'Destatis — Bedeutung der Inflationsrate und Vergleich zum Vorjahreszeitraum', href: 'https://www.destatis.de/DE/Themen/Wirtschaft/Preise/Verbraucherpreisindex/FAQ/inflationsrate.html' }], lastVerified: '2026-07-19',
  },
};
